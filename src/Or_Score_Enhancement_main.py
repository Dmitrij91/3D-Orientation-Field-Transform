...
Enh = Orientation_Score_Enhancment_Filter.Enhancement_Filter_Orientation_Score(Test[60:160,300:400,300:400,:].astype(np.float64),Dir_Array,args.Radius,args.Angle_Res,0.2)
Enh_angle = Orientation_Score_Enhancment_Filter.Filter_Enh_angle_sum(Enh,args.Angle_Max,args.Radius)
